...
const About = () => {
  return (
    <div
      className="w-[99vw] md:w-[100%] min-h-[100vh] flex items-center
    justify-center flex-col bg-gradient-to-l from-[#141414] to-[#0c2025]
    gap-[50px] pt-[80px]"
    >
      ...
      >
        <div
          className="lg:w-[50%] w-[100%] flex items-center
        justify-center"
        >
          <img
            src={about}
            alt=""
            className="lg:w-[65%] w-[80%] shadow-md
          shadow-black rounded-sm"
          />
        </div>
        <div
          className="lg:w-[50%] w-[80%] flex items-start
        justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px]"
        >
          <p
            className="lg:w-[80%] w-[100%] text-[white] md:text-[16px]
          text-[13px]"
          >
            VCart born for smart, seamless shopping-created to deliver quality
            products, trending styles, and everyday essentials in one place.
            With reliable service, fast delivery, and great value , VCart makes
            your online shopping experience simple, satsifying, and stress-free.
          </p>
          <p
            className="lg:w-[80%] w-[100%] text-[white] md:text-[16px]
          text-[13px]"
          ...
          <p
            className="lg:w-[80%] w-[100%] text-[15px] text-[white]
          ...
          >
            ...
            affordability, and convenience. VCart connects customers with
      ...
      >
        ...
        >
          <div
            className="lg:w-[33%] w-[90%] h-[250px]
          border-[1px] border-gray-100 flex items-center justify-center
