...
const Order = () => {
  ...
  return (
    <div
      className="w-[99vw] min-h-[100vh] p-[20px] pb-[150px]
    ...
    >
      ...
      <div className="w-[100%] h-[92%] flex flex-wrap gap-[20px]">
        {orderData.map((item, index) => (
          ...
          >
            <div
              className="w-[100%] h-[80%] flex items-start
            ...
            >
              ...
              <div className="flex items-start justify-center flex-col gap-[5px]">
                ...
                <div className="flex items-center">
                  <p className="md:text-[18px] text-[12px] text-[#aaf4e7]">
                    <span
                      className="text-[#e4fbff] pl-[10px] md:text-[16px]
                    text-[11px]"
                    >
                ...
                <div
                  className="absolute md:left-[55%] md:top-[40%]
                right-[2%] top-[2%]"
                >
                ...
                >
                  <button
                    className="md:px-[15px] px-[5px] py-[3px] md:py-[7px] 
